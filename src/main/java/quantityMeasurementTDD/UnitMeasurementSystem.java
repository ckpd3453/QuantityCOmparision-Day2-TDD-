...
public class UnitMeasurementSystem {
    ...
    public boolean compareTemp(UnitMeasurementSystem temp){
            return Double.compare(this.unit.getBaseUnitValue((this.value * 1.8) + 32.0), temp.unit.getBaseUnitValue(temp.value)) == 0;
    }
